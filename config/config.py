...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Rajababuxd")

#❖  Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "babumusicbot")

#❖  Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "BABU MUSIC")

#❖ get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "BABU_ASS")
...
OWNER_ID = getenv("OWNER_ID", "7391857972")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/RAJA-BABY/BabuMusic",
)
...
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", Flase))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/4c2031ee49a663787dfd9-ad16c95f809da7eab1.jpg"
)
PING_IMG_URL = getenv(
